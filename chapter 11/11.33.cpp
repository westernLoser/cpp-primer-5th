...
using std::ifstream; using std::istringstream; using std::string; using std::map;

map<string, string> build_map(ifstream &trans) {
...
string transform(const map<string, string> &rule_map, const string &word) {
